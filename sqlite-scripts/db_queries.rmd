...
ggplot(ccfiltered, aes(x=yr, y=pcat)) + geom_line() + facet_wrap(~primcat) +  theme(legend.position = "none", strip.text = element_text(size=14)) + ggtitle('All primary categories 1991-2019',  '% of articles in a given category appearing each year') + xlab('Year') + ylab('% of overall volume')
