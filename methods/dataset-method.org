* Downloading arXiv Bulk Source Data
...
- [[#downloading-arxiv-bulk-source-data][Downloading arXiv Bulk Source Data]]
  ...
  - [[#step-1a-download-all-source-files-from-the-arxiv-amazon-web-services-aws-data-storage-using-requestor-pays][Step 1a: Download all source files from the arXiv Amazon Web Services (AWS) data storage using requestor pays.]]
  ...
  - [[#optional-extract-images-and-text-from-pdf-documents-nb-do-this-during-step-2][Optional: Extract images and text from PDF documents (NB: do this during Step 2)]]
  - [[#image-totals][Image totals]]
  - [[#step-4-organise-dataset][Step 4: Organise dataset]]
...
- NB: If you want to also extract images from PDF documents, run the commands in step 3 simultaneously to these commands
